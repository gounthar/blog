...
_Photo from <a href="https://unsplash.com/photos/4eFNfs7iBLc" target="_blank" rel="noopener">Unsplash</a> - Abstract geometric patterns representing the convergence of AI agents and architecture_
...
The complete workflow is available at <a href="https://github.com/gounthar/docker-for-riscv64/blob/main/.github/workflows/cagent-weekly-build.yml" target="_blank" rel="noopener">cagent-weekly-build.yml</a>.
...
The complete workflow is available at <a href="https://github.com/gounthar/docker-for-riscv64/blob/main/.github/workflows/track-cagent-releases.yml" target="_blank" rel="noopener">track-cagent-releases.yml</a>.
...
*   _Project Repository_: <a href="https://github.com/gounthar/docker-for-riscv64" class="bare">https://github.com/gounthar/docker-for-riscv64</a>

*   _Upstream cagent_: <a href="https://github.com/docker/cagent" class="bare">https://github.com/docker/cagent</a>
