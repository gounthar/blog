...
On my host `check-update` came straight back with the full 28 package July batch, and `yum update` took it, with the repository file exactly as it shipped. Total elapsed time once I actually knew the cause: about a minute.
