...
description: Can we get Jenkins to run on Android? Let's find out!
featured: true
hidden: false
image: assets/images/2025/05/22/2025-05-22-jenkins-on-android/love-part-2-16-9.png
tags:
- android
- jdk
- jdk21
...
image::/assets/images/2025/05/22/2025-05-22-jenkins-on-android/love-part-2-16-9.png[jenkins hugging bugdroid]

I know it’s been over two years since link:/2023/03/10/android-and-jenkins/[the first article] of this series, but hey, life happens!
...
image::/assets/images/2025/05/22/2025-05-22-jenkins-on-android/unlock-jenkins.png[standard first Jenkins screen]
...
image::/assets/images/2025/05/22/2025-05-22-jenkins-on-android/plugins-install.png[standard plugins install]

The journey nears its end, punctuated by the customary security warning about the use of the built-in node.
image::/assets/images/2025/05/22/2025-05-22-jenkins-on-android/security-issue.png[standard security warning]
...
Now go back to your console, and Ctrl+C so you firmly ask Jenkins to shut down.
...
image::/assets/images/2025/05/22/2025-05-22-jenkins-on-android/jenkins-home.png[standard Jenkins home page]
...
image::/assets/images/2025/05/22/2025-05-22-jenkins-on-android/jenkins-complaining.png[Jenkins complaining about the absence of an agent]
...
Meanwhile, the authorized\_keys file should be wrapped in the impenetrable cloak of `600 (-rw-------)` permissions.
...
image::/assets/images/2025/05/22/2025-05-22-jenkins-on-android/set-up-agent.png[Jenkins asking to set up an agent]
...
image::/assets/images/2025/05/22/2025-05-22-jenkins-on-android/agent-connected.png[Jenkins agent connected]
...
image::/assets/images/2025/05/22/2025-05-22-jenkins-on-android/no-more-warning.png[No more warning about the built-in node]
...
image::/assets/images/2025/05/22/2025-05-22-jenkins-on-android/first-console-output.png[first Jenkins output console]
...
Let’s use this GitHub repo: <https://github.com/jenkins-docs/simple-java-maven-app>
...
image::/assets/images/2025/05/22/2025-05-22-jenkins-on-android/first-maven-build.png[first Maven build]
