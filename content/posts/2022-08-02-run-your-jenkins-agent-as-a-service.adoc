...
image::/assets/images/2022/08/03/manage-nodes-and-clouds.png[Manage Nodes and Clouds]
...
image::/assets/images/2022/08/03/new-node.png[New node]
...
image::/assets/images/2022/08/03/java-command-to-launch-the-agent.png[Command to launch the agent]
...
image::/assets/images/2022/08/03/curl-and-java-launch-agent.svg[New agent starting]
...
image::/assets/images/2022/08/03/new-node-looks-fine.png[New node looks fine]
